...
This library provides client for the 3scale Service Management API 2.0.

Please contact support@3scale.net before using the API v2.0. You can also use v1.0 ( http://github.com/3scale/3scale_ws_api_for_ruby/tree/v1.0 ) instead.
